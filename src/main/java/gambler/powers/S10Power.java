...
public class S10Power extends BasePower {
    public static final String NAME = "S10Power";
    public static final String POWER_ID = makeID(NAME);
    public static final AbstractPower.PowerType TYPE = PowerType.BUFF;
    public static final boolean TURN_BASED = false;

    public S10Power(final AbstractCreature owner, int amount)
    {
    ...
    public void atStartOfTurnPostDraw() {
        addToBot(new HandChangeAction(this.amount, true));
    }
